                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <b class="nav-link text-light waves-effect waves-dark" style="font-size: 20px;"><i class="fas fa-user-alt"></i> Markarn Doe</b>
                        </li>
                    </ul>
                </div>
            </nav>
                    ...
                    <div class="col-8">
                        <form action="<?=base_url()?>/Admin/save" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control <?= ($validation->hasError('name')) ? 'is-invalid' : ''; ?>" id="name" name="name" placeholder="Name" autofocus value="<?= old('name'); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control <?= ($validation->hasError('stock')) ? 'is-invalid' : ''; ?>" id="stock" name="stock" placeholder="Stock" value="<?= old('stock'); ?>">
                                    <div class="invalid-feedback">
